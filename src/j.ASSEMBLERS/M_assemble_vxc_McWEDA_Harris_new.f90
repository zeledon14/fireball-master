...
! Allocate block size
            ...
            allocate (pvxc_SN_neighbors%blocko(norb_mu, norb_nu))
            allocate (pvxc_SN_bond_neighbors%blocko(norb_mu, norb_nu))
! This are the off side part
            pvxc_SN_neighbors%block = 0.0d0
            pvxc_SN_bond_neighbors%block = 0.0d0
! This are for the atom part (on side part)
            pvxc_SN_neighbors%blocko = 0.0d0
            pvxc_SN_bond_neighbors%blocko = 0.0d0
